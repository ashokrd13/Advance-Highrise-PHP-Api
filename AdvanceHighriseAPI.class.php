<?php
	/*
		* http://www.indianmagentodevelopers.com/
		*
		* Added Custom Field to Person
	*/
	
	class AdvanceHighriseAPI
	{
		public $account;
		public $token;
		protected $curl;
	...
	class HighriseTask extends AdvanceHighriseAPI
	{
		private $highrise;
		public $id;
		public $author_id;
		...
		public function __construct(AdvanceHighriseAPI $highrise)
		{
	...
	class HighriseNote extends AdvanceHighriseAPI
	{
	...
	class HighrisePerson extends AdvanceHighriseAPI
	{
		public $id;
		public $title;
		public $first_name;
		...
		public function addCustomfield($v, $val=FALSE)
		{
			if ($v instanceof HighriseCustomfield && !isset($this->customfields[$v->getSubjectFieldLabel()]))
			{
				...
				$this->original_customfields[$v->getId()] = 1;
			}
